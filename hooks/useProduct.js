                ...
                if (payload) {
                    return (
                        <>
                            <LazyLoad>
                                <img
                                    src={(payload.images && payload.images[0]) ? payload.images[0].src : 'https://jkfenner.com/wp-content/uploads/2019/11/default.jpg'}
                                    alt={getImageURL(payload.name)}
                                />
                            </LazyLoad>
                        </>
                    );
            ...
            if (payload.price) {
                view = (
                    <p className="ps-product__price sale">
                        ...
                        {payload.regular_price > payload.price && (<del className="ml-2">
                            <span>$</span>
                            {formatCurrency(payload.regular_price)}
                        </del>)}
                    </p>
                );
            } else {
